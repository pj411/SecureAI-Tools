...
*/}}
{{- define "secure-ai-tools-message-broker.name" -}}
...
*/}}
{{- define "secure-ai-tools-message-broker.fullname" -}}
...
*/}}
{{- define "secure-ai-tools-message-broker.chart" -}}
...
Common labels
*/}}
{{- define "secure-ai-tools-message-broker.labels" -}}
helm.sh/chart: {{ include "secure-ai-tools-message-broker.chart" . }}
{{ include "secure-ai-tools-message-broker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "secure-ai-tools-message-broker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "secure-ai-tools-message-broker.name" . }}
...
*/}}
{{- define "secure-ai-tools-message-broker.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "secure-ai-tools-message-broker.fullname" .) .Values.serviceAccount.name }}
{{- else }}
